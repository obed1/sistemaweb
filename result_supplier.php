                        ...
                        while ($row1 = $result->fetch_array()) {
                            ...
                            <tr align="center" style="height:25px">
                                ...
                                <td style="border-bottom:1px solid #333;">
                                    ...
                                    <a href="edit_supplier.php?id=<?php echo md5($row1['id']); ?>"><input type="button" value="Editar" style="width:50px; height:20; color:#FFF; background:#069; border:1px solid #069; border-radius:3px;"></a>/<a href="delete_categorias.php?id=<?php echo md5($row1['id']); ?>"><input type="button" value="Eliminar" style="width:15; height:20; color:#FFF; background: #900; border:1px solid #900; border-radius:3px;"></a>

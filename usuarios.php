                ...
                <table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td width="127" height="37" align="right">
                            <a href="javascript:void(0)" onclick="toggle_visibility('popup-box1')"><input type="button" style="border:1px solid #066; background:#066; height:45px; width:125px; color:#FFF; border-radius:3px; font-family: 'Lucida Sans Unicode', 'Lucida Grande', sans-serif;" value="+ Agregar Categoria" /></a></td>
                    </tr>
                    <!--BARRA DEL BUSCADOR-->
                </table><!--BUSCADOR------------------------------------------->
                ...
                <tr>
                    <td>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" align="center" width="80%" style="border:1px solid #066; color:#033; border-radius:3px;">
                            <tr>
                                <th colspan="7" align="center" height="55px" style="border-bottom:1px solid #033; background: #066; color:#FFF;">Informacion de Usuarios</th> 
                            </tr>
                            ...
                            while ($row = mysqli_fetch_array($result)) {
                                ...
                                <tr align="center" style="height:25px">
                                    ...
                                    <td style="border-bottom:1px solid #333;">
                                        <a href="edit_supplier.php?id=<?php echo md5($row['idusuario']); ?>"><input type="button" value="Editar" style="width:50px; height:20; color:#FFF; background:#069; border:1px solid #069; border-radius:3px;"></a>/<a href="delete_usuarios.php?id=<?php echo md5($row['idusuario']); ?>"><input type="button" value="Eliminar" style="width:15; height:20; color:#FFF; background: #900; border:1px solid #900; border-radius:3px;"></a>
                                    </td>
                                </tr>
                                <?php
                            }
            ...
            <div id="popup-wrapper">
                <div id="popup-container">
                    <div id="popup-head-color2">
                        ...
                        <p style="font-family:'Lucida Sans Unicode', 'Lucida Grande', sans-serif;font-size:16px;"> Formulario Agregar Usuario </p>
                    </div>
                    <br>
                    <form action="add_supplier.php" method="POST">
                        <table border="0" align="center">
                            ...
                            <tr>
                                ...
                                <td><input type="text" id="txtbox" name="usuarios" placeholder="Usuario" required><br></td>
                            </tr>
                            <tr>
                                <td align="right">Clave:</td>
                                <td><input type="text" id="txtbox" name="claves" placeholder="Clave" required><br></td>
                            </tr>
                            <tr>
                                <td align="right">Nombre:</td>
                                <td><input type="text" id="txtbox" name="nombres" placeholder="Nombre" required><br></td>
                            </tr>
                            <tr>
                                <td align="right">Correo:</td>
                                <td><input type="text" id="txtbox" name="correos" placeholder="Correo" required><br></td>
                            </tr>
                            <tr>
                                <td align="right">Acceso:</td>
                                <td><input type="text" id="txtbox" name="accesos" placeholder="Acceso" required><br></td>
                            </tr>                   
                            <br>
                            <tr  align="left">
                                <td>&nbsp;  </td>
